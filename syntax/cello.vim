" Vim syntax file
" Language:     C with libCello
" Maintainer:   Dmitry Moscowski <me@corpix.ru>
" Last Change:  2013 Sep 29
...
syn keyword     cOperator       appEnd
syn keyword     cOperator       as_char
syn keyword     cOperator       as_double
syn keyword     cOperator       as_long
syn keyword     cOperator       as_str
syn keyword     cOperator       assign
syn keyword     cOperator       at
syn keyword     cOperator       call
syn keyword     cOperator       collection
syn keyword     cOperator       copy
syn keyword     cOperator       dict
syn keyword     cOperator       eq
syn keyword     cOperator       format
syn keyword     cOperator       hash
syn keyword     cOperator       iter
syn keyword     cOperator       lock
syn keyword     cOperator       new
syn keyword     cOperator       num
syn keyword     cOperator       ord
syn keyword     cOperator       process
syn keyword     cOperator       push
syn keyword     cOperator       retain
syn keyword     cOperator       reverse
syn keyword     cOperator       serialize
...
syn keyword     cType           File Function Int List
syn keyword     cType           Map Mutex None Pool Real
syn keyword     cType           Reference String Table Thread
syn keyword     cType           Tree Type
